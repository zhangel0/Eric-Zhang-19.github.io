...
![EvaporativeCoolerTest](assets/img/Evap_Cooler_Test.png)
Figure 2: Creating the desert-like environment with the dehumidifier, then testing the evaporative cooling system in the now hot and dry environment.
